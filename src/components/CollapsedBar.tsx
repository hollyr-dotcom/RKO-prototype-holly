  ...
  return (
    <div className="fixed top-0 left-0 z-50 pt-5 pl-5">
      <button
        ...
        className="flex items-center gap-1 bg-white hover:bg-gray-50 rounded-full border border-black/5 transition-colors duration-200 py-2 pl-3 pr-5 shadow-chrome"
