          ...
          <div className="flex flex-col gap-6 px-4 pb-4">
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-3">
                ...
                <motion.button
                  className="self-start h-8 px-4 rounded-[18px] text-sm text-[#222428] border border-[#e0e2e8] bg-white hover:bg-[#222428] hover:text-white hover:border-[#222428] transition-colors"
